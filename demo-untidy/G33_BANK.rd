...
dataRequest{
        table 'repriceRate',{
            name 'repriceRateNormal'
            allDimensions (['rpid','currency','date','organ'])
        }
        fields 'currency,sum(balance) balance,rpid'
        groupFields 'rpid,currency'
        params {
            date 'context[]'
            staticModel 'context[]'
            organ 'context[]'
...
dataGrids{
    ...
    apply sel([rowdim:1,rpid:10000..10012]),{
        formula {rowRel(1)+rowRel(2)+rowRel(3)+rowRel(4)}
    }
    ...
    apply sel([rowdim:3,rpid:10000]),{
        formula{
            ...
            v([dataRequest:'repriceRateOverdue'])+               //逾期贷款glitem 有问题
            v([dataRequest:'repriceRateNormal'])+                 //正常货代reRate
            v([item:'S1307',dataRequest:'repriceRate'])
        }
    }
    apply sel([rowdim:3,rpid:10001..10012]),{
        formula{
            v([dataRequest:'repriceRateNormal'])+                 //正常货代  有问题----已经处理
            v([item:'S1307',dataRequest:'repriceRate'])
        }
    }
...
apply sel([rowdim:4,rpid:10000]),{
        formula{
             v0([dict:'zqtz_m1',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10001]),{
        formula{
             v0([dict:'zqtz_m2',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10002]),{
        formula{
             v0([dict:'zqtz_m3',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10003]),{
        formula{
             v0([dict:'zqtz_m4',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10004]),{
        formula{
             v0([dict:'zqtz_m5',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10005]),{
        formula{
             v0([dict:'zqtz_m6',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10006]),{
        formula{
             v0([dict:'zqtz_m7',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10007]),{
        formula{
             v0([dict:'zqtz_m8',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10008]),{
        formula{
             v0([dict:'zqtz_m9',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10009]),{
        formula{
             v0([dict:'zqtz_m10',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10010]),{
        formula{
             v0([dict:'zqtz_m11',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10011]),{
        formula{
             v0([dict:'zqtz_m12',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:4,rpid:10012]),{
        formula{
             v0([dict:'zqtz_m13',dataRequest:'manualData']) 
        }
    }
//--------------
    apply sel([rowdim:5,rpid:10000]),{
        formula{
            sumItemsWithMinus0(['S1002','S1003'],['0013'],[bal:'debit',dataRequest:'glAllBranch'])+
            mathPositive(
                v0([item:"0013",bal:'debit',dataRequest:'glAllBranch']),
                v0([item:"S2006",bal:'credit',dataRequest:'glAllBranch']),0
            )
        }
    }
//手工维护 1.4其他生息资产
    apply sel([rowdim:5,rpid:10001]),{
        formula{
             v0([dict:'qtsxzc_m2',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10002]),{
        formula{
             v0([dict:'qtsxzc_m3',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10003]),{
        formula{
             v0([dict:'qtsxzc_m4',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10004]),{
        formula{
             v0([dict:'qtsxzc_m5',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10005]),{
        formula{
             v0([dict:'qtsxzc_m6',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10006]),{
        formula{
             v0([dict:'qtsxzc_m7',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10007]),{
        formula{
             v0([dict:'qtsxzc_m8',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10008]),{
        formula{
             v0([dict:'qtsxzc_m9',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10009]),{
        formula{
             v0([dict:'qtsxzc_m10',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10010]),{
        formula{
             v0([dict:'qtsxzc_m11',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10011]),{
        formula{
             v0([dict:'qtsxzc_m12',dataRequest:'manualData']) 
        }
    }
apply sel([rowdim:5,rpid:10012]),{
        formula{
             v0([dict:'qtsxzc_m13',dataRequest:'manualData']) 
        }
    }
...
//end 1.4
    ...
    apply sel([rowdim:14,rpid:1]),{
        formula{
            sumItems0(['S1032','S1112','S1231','S1309','S1432','S1442','S1502','S1504','S1512','S1523','S1603','S1605','S1703','S2007','S2013','S2211','S2221','S2231','S2232','S2241','S2401','S2701','S2702','S2711','S2801','S2901'],[bal:'credit',dataRequest:'glAllBranch'])+
